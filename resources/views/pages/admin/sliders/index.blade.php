                            ...
                            <div class="card" style="width:100%; margin-bottom: 25px;">
                                ...
                                <div class="card-body"  style="text-align: -webkit-center;">
                                    ...
                                    @if  ($slider->status == '0')
                                        ...
                                        title="{{ trans('slider_trans.Delete') }}"><i class="fa fa-eye-slash"></i> Un Visible </button>
                                    @elseif ($slider->status == '1')
                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#edit{{ $slider->id }}"
                                        title="{{ trans('slider_trans.Delete') }}"><i class="fa fa-eye"></i> Visible </button>
                                    @endif

                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#delete{{ $slider->id }}"
                                            title="{{ trans('slider_trans.Delete') }}"><i class="fa fa-trash"></i> Delete </button>
                                </div>
                            </div>
                        </div>
