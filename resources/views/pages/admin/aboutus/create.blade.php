                    ...
                    <div class="row beauty_top">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('aboutus_ar', old('aboutus_ar'), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('aboutus_en', old('aboutus_en'), ['class' => 'form-control summernote']) !!}
                        ...
                        <h2 class="help">{{ trans('front_trans.numbers') }}</h2>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('experience_year', old('experience_year'), ['class' => 'form-control']) !!}
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('previous_project', old('previous_project'), ['class' => 'form-control']) !!}
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('under_construction', old('under_construction'), ['class' => 'form-control']) !!}
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('client', old('client'), ['class' => 'form-control']) !!}
                    ...
                    <div class="row beauty">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('message_ar', old('message_ar'), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('message_en', old('message_en'), ['class' => 'form-control summernote']) !!}
                    ...
                    <div class="row beauty">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('vision_ar', old('vision_ar'), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('vision_en', old('vision_en'), ['class' => 'form-control summernote']) !!}
                    ...
                    <div class="row beauty">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('whyus_ar', old('whyus_ar'), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('whyus_en', old('whyus_en'), ['class' => 'form-control summernote']) !!}
