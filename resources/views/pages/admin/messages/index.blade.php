                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{ route('contactus/messages_read', 'test') }}" method="post">
                                                {{ method_field('post') }}
                                                @csrf
                            ...
                            <div class="modal fade" id="delete{{ $message->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('contactus/messages_delete', 'test') }}" method="post">
                                                {{ method_field('Post') }}
                                                @csrf
                ...
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>{{ trans('contactus_trans.Name') }}</th>
                            <th>{{ trans('contactus_trans.Notes') }}</th>
                            <th>{{ trans('contactus_trans.Processes') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <form action="#" method="post" id="message-delete-{{ $message->id }}" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
