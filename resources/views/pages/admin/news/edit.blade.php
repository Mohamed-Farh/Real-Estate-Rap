                    ...
                    <div class="row beauty_top">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('head_ar', old('head_ar', $new->head_ar), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('head_en', old('head_en', $new->head_en), ['class' => 'form-control summernote']) !!}
                    ...
                    <div class="row beauty">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('body_ar', old('body_ar', $new->body_ar), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('body_en', old('body_en', $new->body_ar), ['class' => 'form-control summernote']) !!}
